...
# Скачиваем изображения с сайта www.ptz-trans.ru.
# Проверяем, что изображения загружены.
# Если успешно, то переносим изображения в основную папку и завершаемся с нулевым кодом возврата.
# Иначе завершаемся с кодом возврата 1.
